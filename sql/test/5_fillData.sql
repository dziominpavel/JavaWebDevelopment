-- -----------------------------------------------------
-- Data for table `trade_test`.`user`
-- -----------------------------------------------------
USE `trade_test`;
-- -----------------------------------------------------
-- Data for table `trade_test`.`user`
...
-- -----------------------------------------------------
-- Data for table `trade_test`.`products`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Data for table `trade_test`.`receipt`
-- -----------------------------------------------------
INSERT INTO `receipt` (user_id, date, sum) VALUES (2, '2019-10-22T22:07:20', 12.50);
-- -----------------------------------------------------
-- Data for table `trade_test`.`salesitem`
-- -----------------------------------------------------
INSERT INTO `salesitem` (receipt_id, product_id, count, sum) VALUES (1, 2, 2, 65.5);