...
public class ReceiptManagerImpl extends BaseManager implements ReceiptManager {
    ...
    Logger logger = Logger.getLogger(ReceiptManagerImpl.class);
    ...
    public void addSalesItem(final String barcode, final ReceiptDTO currentReceipt) throws ServiceException, ValidationException {
        ...
        addSalesItemToReceipt(currentReceipt, productDTO);
    }
    ...
    public void createReceipt(final ReceiptCreateDTO currentReceipt) throws ValidationException, ServiceException {
        ...
        ReceiptEntity created = receiptService.createReceipt(receipt);
    }

    private void addSalesItemToReceipt(ReceiptDTO currentReceipt,
                                 ProductDTO product) throws ValidationException {
        ...
        SalesItemDTO salesItem = findSalesItemInReceipt(salesItems, product.getBarcode());
