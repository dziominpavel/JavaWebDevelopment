        ...
        switch (type) {
            ...
            case LEKSEMS_BY_SYMBOL_COUNT_DESC: {
                ...
                Comparator<LeksemaComponent> firstComparator =
                        Comparator.comparingInt(
                                c -> c.getSymbolCount(compareSymbol));
